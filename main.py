...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] =pygame.image.load('FLAPPY BIRD/gallery/sprites/message.png').convert_alpha()
    GAME_SPRITES['base'] =pygame.image.load('FLAPPY BIRD/gallery/sprites/base.png').convert_alpha()
    GAME_SPRITES['pipe'] =(pygame.transform.rotate(pygame.image.load('FLAPPY BIRD/gallery/sprites/pipe.png').convert_alpha(), 180), 
    pygame.image.load('FLAPPY BIRD/gallery/sprites/pipe.png').convert_alpha()
    )
    ...
    GAME_SOUNDS['start'] = pygame.mixer.Sound('FLAPPY BIRD/gallery/audio/start.wav')

    GAME_SOUNDS['start'].play()

    GAME_SPRITES['background'] = pygame.image.load('FLAPPY BIRD/gallery/sprites/background.jpg').convert()
    GAME_SPRITES['player'] = pygame.image.load('FLAPPY BIRD/gallery/sprites/bird.png').convert_alpha()
